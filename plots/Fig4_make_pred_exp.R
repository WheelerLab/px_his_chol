...
HCHS_yGTEx <- fread('/home/angela/px_his_chol/PrediXcan/TW_Artery_Coronary_0.5.db_predicted_expression.txt', header = T)
...
MESA_HIS_yGTEx <- fread('/home/angela/px_his_chol/MESAreplication/PrediXcan/TW_Artery_Coronary_0.5.db_predicted_expression.txt')
...
pdf("/home/angela/px_his_chol/Manuscript_figures/Fig4.pdf", width = 5.5, height = 3)
plot_grid(HCHS, MESA_HIS, labels = c('A', 'B'), scale = c(.9, .9, .9, .9))
dev.off()

tiff("/home/angela/px_his_chol/Manuscript_figures/Fig4.tiff", width = 13.97, height = 7.62, units = 'cm', res = 300, compression = 'lzw')
plot_grid(HCHS, MESA_HIS, labels = c('A', 'B'), scale = c(.9, .9, .9, .9))
dev.off()